...
PREDICTED_LABELS = ["crack","uncrack"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/2406a3e7-3ccf-4901-b418-6aba172aa24d'  #Edit 2
...
st.title("Concrete Classification Cracked Uncracked")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Cracked Uncracked Concrete Image Classifier")#change according to your project   #edit 3
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/ABVSREDDY/crack_uncrack_concrete")
  ...
  #https://github.com/ABVSREDDY/crack_uncrack_concrete/blob/main/requirements.txt
  # pdf_url ="https://github.com/ABVSREDDY/crack_uncrack_concrete/blob/main/sample.pdf"
  pdf_url="https://raw.githubusercontent.com/ABVSREDDY/crack_uncrack_concrete/main/Concrete Integrity Analysis-A Machine Learning Approach to Crack Detection.pdf"
