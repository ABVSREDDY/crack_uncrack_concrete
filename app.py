...
PREDICTED_LABELS = ["crack,uncrack"]
PREDICTED_LABELS.sort()


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/2406a3e7-3ccf-4901-b418-6aba172aa24d'
...
st.title("Crack and Uncrack Classifier")#change according to your project
